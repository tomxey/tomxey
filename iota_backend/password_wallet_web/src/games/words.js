...
const ANIMALS = [
  ...
  'zebra', 'hipopotam', 'nosorożec', 'wielbłąd', 'kangur', 'panda', 'jeleń', 'foka',
  ...
  'mrówkojad', 'leniwiec', 'tapir', 'kret', 'ryjówka', 'chomik', 'szczur', 'szynszyla',
  'fretka', 'wróbel', 'gołąb', 'sikorka', 'kos', 'szpak', 'jaskółka', 'skowronek', 'słowik',
  'dzięcioł', 'kukułka', 'sroka', 'wrona', 'kruk', 'gawron', 'czapla', 'bocian', 'żuraw',
  'flaming', 'pelikan', 'łabędź', 'mewa', 'albatros', 'kormoran', 'zimorodek', 'jastrząb',
  'sokół', 'sęp', 'kondor', 'puchacz', 'bażant', 'przepiórka', 'indyk', 'kogut', 'tukan',
  'kanarek', 'karp', 'szczupak', 'okoń', 'sum', 'węgorz', 'łosoś', 'pstrąg', 'śledź',
  'sardynka', 'tuńczyk', 'dorsz', 'flądra', 'murena', 'rozgwiazda', 'jeżowiec', 'małż',
  'ostryga', 'homar', 'krewetka', 'langusta', 'kalmar', 'koralowiec', 'żmija', 'boa', 'pyton',
  'kobra', 'grzechotnik', 'kameleon', 'gekon', 'legwan', 'waran', 'aligator', 'salamandra',
  'ropucha', 'osa', 'szerszeń', 'trzmiel', 'chrząszcz', 'żuk', 'karaluch', 'świerszcz',
  'konik', 'ważka', 'komar', 'mucha', 'bąk', 'kleszcz', 'skorpion', 'gąsienica', 'modliszka',
  'świetlik', 'mamut', 'dinozaur', 'tyranozaur', 'triceratops', 'stegozaur', 'brontozaur',
  'pterodaktyl', 'szkielet'
];
...
const FOOD = [
  ...
  'guma', 'cukierek', 'chałwa', 'marcepan', 'galaretka', 'budyń', 'kisiel', 'krem', 'malina',
  'jeżyna', 'borówka', 'porzeczka', 'brzoskwinia', 'morela', 'ananas', 'mango', 'kiwi',
  'granat', 'rodzynka', 'melon', 'mandarynka', 'grejpfrut', 'limonka', 'awokado', 'kokos',
  'burak', 'rzodkiewka', 'pietruszka', 'seler', 'por', 'szpinak', 'brokuł', 'kalafior',
  'brukselka', 'fasola', 'groch', 'bakłażan', 'cukinia', 'papryka', 'chili', 'oliwka',
  'szparag', 'sałata', 'koperek', 'bazylia', 'mięta', 'szczypiorek', 'ryż', 'kasza', 'mąka',
  ...
  'kaszanka', 'schab', 'jogurt', 'kefir', 'śmietana', 'twaróg', 'herbata', 'kawa', 'kakao',
  'sok', 'lemoniada', 'kompot', 'woda', 'wino', 'piwo', 'szampan', 'koktajl', 'smoothie',
  'sól', 'pieprz', 'cukier', 'ocet', 'musztarda', 'ketchup', 'majonez', 'dżem', 'powidła',
  'nutella', 'syrop', 'olej', 'oliwa', 'pierogi', 'bigos', 'gołąbki', 'placki', 'kluski',
  'kopytka', 'żurek', 'rosół', 'barszcz', 'flaki', 'zapiekanka', 'frytki', 'hamburger',
  'hotdog', 'kebab', 'sushi', 'taco', 'burrito', 'lasagne', 'spaghetti', 'omlet',
  'jajecznica', 'tosty'
];
...
const HOUSEHOLD = [
  ...
  'garnek', 'patelnia', 'czajnik', 'wiadro', 'szczotka', 'grzebień', 'mydło', 'ręcznik',
  'plecak', 'torba', 'portfel', 'moneta', 'klepsydra', 'wachlarz', 'globus', 'mapa', 'fotel',
  'taboret', 'ława', 'biurko', 'regał', 'półka', 'komoda', 'kredens', 'wieszak', 'materac',
  'kołdra', 'prześcieradło', 'firanka', 'zasłona', 'roleta', 'żyrandol', 'obraz', 'ramka',
  'wazon', 'doniczka', 'świecznik', 'filiżanka', 'miska', 'taca', 'tarka', 'deska', 'wałek',
  'blender', 'mikser', 'toster', 'piekarnik', 'kuchenka', 'zmywarka', 'pralka', 'suszarka',
  'żelazko', 'odkurzacz', 'mop', 'gąbka', 'kosz', 'słoik', 'puszka', 'karton', 'pudełko',
  'torebka', 'siatka', 'kufer', 'skrzynia', 'sejf', 'szuflada', 'zamek', 'klamka', 'zawias',
  'dzwonek', 'pasta', 'szampon', 'balsam', 'perfumy', 'lakier', 'lokówka', 'maszynka',
  'brzytwa', 'pęseta', 'cążki', 'pilnik', 'wata', 'plaster', 'bandaż', 'strzykawka',
  'tabletka', 'kołyska', 'wózek', 'grzechotka', 'pielucha', 'budzik', 'kalendarz', 'notes',
  'zeszyt', 'teczka', 'linijka', 'cyrkiel', 'gumka', 'kredka', 'flamaster', 'marker', 'klej',
  'taśma', 'zszywacz', 'spinacz', 'pinezka', 'koperta', 'znaczek', 'pocztówka', 'list',
  'paczka'
];
...
const NATURE = [
  ...
  'lawina', 'huragan', 'zaćmienie', 'kometa', 'meteoryt', 'galaktyka'
];

const VEHICLES = [
  'rower', 'rakieta', 'sanie', 'balon', 'latawiec', 'samochód', 'autobus', 'pociąg',
  'samolot', 'statek', 'łódka', 'helikopter', 'motocykl', 'hulajnoga', 'traktor',
  'ciężarówka', 'karetka', 'tramwaj', 'spadochron', 'skuter', 'quad', 'gokart', 'limuzyna',
  'taksówka', 'furgonetka', 'kamper', 'przyczepa', 'wywrotka', 'śmieciarka', 'radiowóz',
  'kombajn', 'buldożer', 'spychacz', 'czołg', 'transporter', 'łazik', 'lokomotywa', 'wagon',
  'kolejka', 'metro', 'trolejbus', 'żaglówka', 'jacht', 'katamaran', 'kajak', 'kanoe',
  'ponton', 'tratwa', 'prom', 'okręt', 'wiosło', 'ster', 'maszt', 'szybowiec', 'awionetka',
  'odrzutowiec', 'dron', 'wahadłowiec', 'satelita', 'karuzela', 'rollercoaster'
];
...
const MUSIC_AND_SPORT = [
  ...
  'lotka', 'kij', 'krążek', 'bramka', 'obręcz', 'siodełko', 'kierownica', 'sztanga',
  'ciężarek', 'skakanka', 'trampolina', 'drążek', 'mata', 'ochraniacz', 'gwizdek', 'puchar',
  'trofeum', 'wieniec', 'podium', 'sędzia', 'trener', 'oszczep', 'kula', 'tyczka', 'łuk',
  'strzała', 'tarcza', 'szpada', 'floret', 'szabla'
];
...
const PEOPLE = [
  ...
  'biskup', 'papież', 'szaman', 'wróżka', 'czarodziej', 'wiedźma', 'olbrzym', 'krasnal',
  'skrzat', 'elf', 'goblin', 'troll', 'ogr', 'centaur', 'minotaur', 'cyklop', 'wilkołak',
  'zombi', 'demon', 'diabeł', 'strażak', 'policjant', 'lekarz', 'pielęgniarka', 'dentysta',
  'weterynarz', 'nauczyciel', 'uczeń', 'student', 'profesor', 'naukowiec', 'astronauta',
  'stewardesa', 'kierowca', 'marynarz', 'kapitan', 'rybak', 'myśliwy', 'rolnik', 'ogrodnik',
  'pasterz', 'drwal', 'górnik', 'murarz', 'stolarz', 'kowal', 'szewc', 'krawiec', 'fryzjer',
  'piekarz', 'rzeźnik', 'kelner', 'barman', 'sprzedawca', 'listonosz', 'kominiarz',
...
const TOYS_AND_GAMES = [
  'lalka', 'miś', 'pluszak', 'klocki', 'układanka', 'puzzle', 'malowanka', 'plastelina',
  'origami', 'bańka', 'rolki', 'wrotki', 'karty', 'szachy', 'warcaby', 'domino', 'krzyżówka',
  'bumerang', 'frisbee', 'petarda', 'fajerwerk', 'konfetti', 'serpentyna', 'prezent'
];

const SYMBOLS = [
  'krzyż', 'koło', 'kwadrat', 'prostokąt', 'spirala', 'zygzak', 'nuta', 'płomień',
  'śnieżynka', 'podkowa', 'flaga', 'bukiet', 'zegar', 'bomba', 'dynamit'
];

const MISC = [
  'miecz', 'armata', 'skarb', 'trumna', 'diament', 'perła', 'klejnot', 'pierścień',
  'kryształ', 'zbroja', 'topór', 'włócznia', 'beczka', 'dzban', 'pochodnia', 'ognisko',
  'kominek', 'sito', 'igła', 'nitka', 'szpilka'
];
